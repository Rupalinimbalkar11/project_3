			...
			<div class="wrap">
				<div class="option-box">
					...
					<table class="form-table">
						...
						<tr valign="top">
							<th scope="row">
								<label for="ztsmartslider_styles"><?php _e('Slider Styles', 'post-sliders')?></label><br />
								<span class="postsliderhints"><?php _e('Choose your post slider style. all style available only version. ','post-sliders'); ?></span></th>
								<td>
								<label><input type="radio" name="ztsmartslider_styles" id="ztsmartslider_styles" value="1" <?php if(get_post_meta($post->ID, 'ztsmartslider_styles', true)=="1") {echo "checked";}?> ><?php _e('Post Slider Style 1', 'post-sliders')?>
						 ...
						 <tr valign="top">
							<th></th>
							<td>
								<label><input type="radio" name="ztsmartslider_styles" id="ztsmartslider_styles" value="3" <?php if(get_post_meta($post->ID, 'ztsmartslider_styles', true)=="3") {echo "checked";}?>><?php _e('Post Slider Style 3', 'post-sliders')?>
								<img src= "<?php echo ZTSMARTSLIDER_PLUGIN_PATH. '\assets\images\centre.png';?>"/>
							</label>
						</td>
						<td>
							<label><input type="radio" name="ztsmartslider_styles" id="ztsmartslider_styles" value="4" <?php if(get_post_meta($post->ID, 'ztsmartslider_styles', true)=="4") {echo "checked";}?>><?php _e('Post Slider Style 4', 'post-sliders')?>
							<img src= "<?php echo ZTSMARTSLIDER_PLUGIN_PATH. '\assets\images\fade.png';?>"/></label></td>
						</tr>
						<tr valign="top">
							<th></th>
							<td>
								<label><input type="radio" name="ztsmartslider_styles" id="ztsmartslider_styles" value="5" <?php if(get_post_meta($post->ID, 'ztsmartslider_styles', true)=="5") {echo "checked";}?> ><?php _e('Post Slider Style 5', 'post-sliders')?>
								<img src= "<?php echo ZTSMARTSLIDER_PLUGIN_PATH. '\assets\images\adaptive.png';?>"/> 
							</label>
						    </td>
						<td> 
							<label><input type="radio" name="ztsmartslider_styles" id="ztsmartslider_styles" value="6" <?php if(get_post_meta($post->ID, 'ztsmartslider_styles', true)=="6") {echo "checked";}?>><?php _e('Post Slider Style 6', 'post-sliders')?>
		...
		<li style="<?php if($nav_value == 3){echo "display: block;";} else{ echo "display: none;"; }?>" class="box3 tab-box <?php if($nav_value == 3){echo "active";}?>"> 
			<div class="wrap">
				<div class="option-box">
					...
					<td>
					<ul id="sortlist">
						<?php if(is_array($ztsmartslider_content_layout)){
							$content_layout = $ztsmartslider_content_layout;
							}
							else{
								$content_layout[] = $ztsmartslider_content_layout;
							}?>
					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="title" <?php if(in_array('title',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Title</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="descr" <?php if(in_array('descr',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Description</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="cat" <?php if(in_array('cat',$content_layout)){echo "checked";}?>>
                    <label for="postsliders">Category</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="author_info" <?php if(in_array('author_info',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Author info</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="date_time" <?php if(in_array('date_time',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Date Time</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="read_more" <?php if(in_array('read_more',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Read More</label><br></li>

					<li><input type="checkbox"  name="ztsmartslider_content_layout[]" value="image" <?php if(in_array('image',$content_layout)){echo "checked";}?>>
					<label for="postsliders">Image</label><br></li>
					</ul>
					</td>
					</tr>
					<!-- end.... -->
