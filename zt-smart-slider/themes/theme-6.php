...
wp_enqueue_script('ztsmartslider_sliderslickmin_js');
 ...
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6{
         background: #'.$ztsmartslider_bg_color.';
         border: '.$ztsmartslider_border_size.'px solid #'.$ztsmartslider_border_colors.';
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .ztsmartslider_style6_title > a{
     ...
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .ztsmartslider_style6_title a:hover{
         color: #'.$ztsmartslider_titlehover_color.';
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .post_slider_style_post_date{
     ...
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .post_slider_style_post_author a{
         color: #'.$ztsmartslider_author_color.';
         font-size: '.$ztsmartslider_author_size.'px;
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .ztsmartslider_style6_description{
 ...
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .zts_single_excerpt_area{
         text-align: left;
     }
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .zts_single_excerpt_area > a {
         color: #'.$ztsmartslider_excerpt_colors.';
         font-size: '.$ztsmartslider_excerpt_size.'px;
         text-decoration: none;
         box-shadow: none;
     }
     #ztcarousel-'.$postid.' .ztsmartslider_style6 .zts_single_excerpt_area > a:hover {
 ...
 $html.='
     ...
     #ztcarousel-'.$postid.' .ztsmartslider_style6_container{
         display:block;
         overflow:hidden;
         padding:15px;
         line-height:28px;
 ...
 require_once('excerpt.php');
	...
	$html.='
		<div class="ztsmartslider_style6">
			<div class="shadow-effect">		
				<div class="ztsmartslider_style6_thumb">';
				...
				<div class="ztsmartslider_style6_container">
					
				<div class="ztsmartslider_style6_info">';

				if(in_array('title',$ztsmartslider_content_layout)){
				$html.='<div class="ztsmartslider_style6_title">
				...
				$html.=
					'<div class="ztsmartslider_style6_description">
