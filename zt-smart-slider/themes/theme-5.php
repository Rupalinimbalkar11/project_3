...
wp_enqueue_script('ztsmartslider_sliderslickmin_js');
 ...
 if($ztsmartsliderpr_paginations_style == 1){
     $html .='
     #ztcarousel-'.$postid.'.owl-theme .owl-dots .owl-dot span {
       backface-visibility: visible;
       background: #'.$ztsmartsliderpr_paginations_bgcolor.';
       border-radius: 30px;
       display: block;
       height: 10px;
       margin: 5px 7px;
 ...
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5{
         background: #'.$ztsmartslider_bg_color.';
         border: '.$ztsmartslider_border_size.'px solid #'.$ztsmartslider_border_colors.';
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .ztsmartslider_style5_title > a{
     ...
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .ztsmartslider_style5_title a:hover{
         color: #'.$ztsmartslider_titlehover_color.';
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .post_slider_style_post_date{
     ...
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .post_slider_style_post_author a{
         color: #'.$ztsmartslider_author_color.';
         font-size: '.$ztsmartslider_author_size.'px;
     }
     ';
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .ztsmartslider_style5_description{
 ...
 $html .='
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .zts_single_excerpt_area{
         text-align: left;
     }
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .zts_single_excerpt_area > a {
         color: #'.$ztsmartslider_excerpt_colors.';
         font-size: '.$ztsmartslider_excerpt_size.'px;
         text-decoration: none;
         box-shadow: none;
     }
     #ztcarousel-'.$postid.' .ztsmartslider_style5 .zts_single_excerpt_area > a:hover {
 ...
 $html.='
     ...
     #ztcarousel-'.$postid.' .ztsmartslider_style5_container{
         display:block;
         overflow:hidden;
         padding:15px;
         line-height:28px;
 ...
 require_once('excerpt.php');
	...
	$html.='
		<div class="ztsmartslider_style5">
			<div class="shadow-effect">		
				<div class="ztsmartslider_style5_thumb">';
				...
				$html.='
				<div class="ztsmartslider_style5_container">
					<div class="ztsmartslider_style5_title">
				...
				if(in_array('title_des',$ztsmartslider_content_layout)){
				$html.='
				<div class="ztsmartslider_style5_description">
