<?php
	...
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2{
			background: #'.$ztsmartslider_bg_color.';
			border: '.$ztsmartslider_border_size.'px solid #'.$ztsmartslider_border_colors.';
		}
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .ztsmartslider_style2_title > a{
		...
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .ztsmartslider_style2_title a:hover{
			color: #'.$ztsmartslider_titlehover_color.';
		}
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .post_slider_style_post_date{
		...
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .post_slider_style_post_author a{
			color: #'.$ztsmartslider_author_color.';
			font-size: '.$ztsmartslider_author_size.'px;
		}
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .ztsmartslider_style2_description{
		...
		';
	$html .='
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .zts_single_excerpt_area{
			text-align: left;
		}
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .zts_single_excerpt_area > a {
			color: #'.$ztsmartslider_excerpt_colors.';
			font-size: '.$ztsmartslider_excerpt_size.'px;
			text-decoration: none;
			box-shadow: none;
		}
		#ztcarousel-'.$postid.' .ztsmartslider_style2 .zts_single_excerpt_area > a:hover {
	...
	$html.='
		...
		#ztcarousel-'.$postid.' .ztsmartslider_style2_container{
			display:block;
			overflow:hidden;
			padding:15px;
			line-height:28px;
	...
	$html.='
		<div class="ztsmartslider_style2">
			<div class="shadow-effect">	';	
			if(in_array('image',$ztsmartslider_content_layout)){
				$html.='<div class="ztsmartslider_style2_thumb">';
...
<<<<<<< HEAD
				...
				$html.='
				<div class="ztsmartslider_style2_container">
					<div class="ztsmartslider_style2_title">
...
=======
				$html.='<div class="ztsmartslider_style2_container">';
				if(is_array($ztsmartslider_content_layout)){
					if(in_array('title_des',$ztsmartslider_content_layout)){
						'<div class="ztsmartslider_style2_title">
							<a href="'.esc_url(get_the_permalink()).'">'.esc_attr(get_the_title()).'</a>
						</div>';
				...
				$html.='<div class="ztsmartslider_style2_info">';
				if(is_array($ztsmartslider_content_layout)){
					if(in_array('date_time',$ztsmartslider_content_layout)){
...
>>>>>>> 41c76d1d8b30a818eced2e106cbb44bc7cbff8dc
				}
				...
				if(in_array('title_des',$ztsmartslider_content_layout)){
				$html.='
				<div class="ztsmartslider_style2_description">
